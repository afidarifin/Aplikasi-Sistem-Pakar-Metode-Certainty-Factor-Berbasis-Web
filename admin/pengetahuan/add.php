  ...
  <?php
    if(isset($_POST['submit'])) {
      ...
      if(empty($kode_pengetahuan) || empty($md) || empty($mb) || empty($gejala) || empty($gangguan)) {
        ...
        $insert_pengetahuan = $db->table('pengetahuan')
        ->insert(
          [
            ...
            <div class="row">
              <div class="col-md-8" style="margin-top: 15px;">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="kode_pengetahuan" value="" class="form-control" placeholder="Contoh: P001" autocomplete="off" spellcheck="false" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="md" value="" class="form-control" placeholder="Contoh: 0.4" autocomplete="off" spellcheck="false" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="mb" value="" class="form-control" placeholder="Contoh: 0.8" autocomplete="off" spellcheck="false" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">
                      ...
                      <?php
                        ...
                        if(count($gangguan) > 0) {
                          ...
                          foreach($gangguan as $data) {
                            ?>
                              <option value="<?php echo $data->id_gangguan; ?>">
